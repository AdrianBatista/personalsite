...
Plain HTML5 / CSS3 / vanilla JavaScript, with GSAP, Lenis, and SplitType for motion and typography (see [.github/skills/premium-frontend-ui/SKILL.md](.github/skills/premium-frontend-ui/SKILL.md)). No framework, no build tool yet.
